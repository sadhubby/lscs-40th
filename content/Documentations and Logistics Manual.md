...
## Creating an Activity Folder

1. Open your Sheets tracker in the Google Sheets Sistema. You will be able to see your current assignments for the term. 
2. Navigate to **40th Documentations and Logistics Google Drive** > **[1] Activity Folders** > **[X] Committee Name** >**Term X / Yearlong**
3. Create a new folder for each activity assigned to you. Follow this format for the folder name: **“[Activity Date] Activity Title”**  
	3.1 Should the activity be  
4. Create separate folders for Pre-Acts and Post-Acts. Follow this format for the folder name: **“[1] Pre-Acts”** and **“[2] Post-Acts”**
5. If the event is synchronous, include a folder inside [**1] Pre-Acts** entitled **“Forms”**
6. If the event needs additional permits, create a third folder with the name: **“[3] Permits”** 

## Templates

To be able to see the requirements of a certain activity, consult the **CSO Activity Reference Guide.** 


> [!NOTE] ARG Flaws
> The CSO Activity Reference Guide is deeply flawed. It is not all too accurate, especially for activities that may or may not have some overlap in its types. As such, it is best practice to have the templates checked first by Evan to assure validity. Should there be a concern, Evan will bring it up with the CSO EVC-D for clarification, then relayed to you. 
