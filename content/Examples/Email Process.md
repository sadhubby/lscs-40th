...
**EMAIL SUBJECT**: [LSCS PRE-ACTS] Event Name <br>
**SEQUENCE**:
VP FIN -> EVP of DIVISION -> EVP-OPS for Endorsement -> FACULTY ADVISER
...
**EMAIL SUBJECT**: [LSCS] Letter of Invitation Request <br>
**SEQUENCE**
PRESIDENT -> MS. MARJ

## Notes
- Email PRESIDENT for signature on revised Pre-Acts
